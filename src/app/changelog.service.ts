...
export class ChangelogService {
    private readonly url = 'https://raw.githubusercontent.com/aspojo/ngx-ui-split/master/CHANGELOG.md';
    // else 'https://rawgit.com/aspojo/ngx-ui-split/master/CHANGELOG.md';
