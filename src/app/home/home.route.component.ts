...
@Component({
  ...
  template: `
    <div class="container">
        <div class="jumbotron">
            <h1>ngx-ui-split 
              <a href="https://badge.fury.io/js/ngx-ui-split"><img src="https://badge.fury.io/js/ngx-ui-split.svg" alt="npm version" height="18"></a>
            </h1>
            <h4>Angular UI library used to split views and to allow dragging to resize the split areas using CSS flexbox layout.</h4>
            <br>
            <p><b>Warning</b>: Versions <code>1.x</code> needs <code>@angular/*@6.x</code> to work, use <code>0.2.x</code> for older angular versions (<a href="https://aspojo.github.io/ngx-ui-split/old_0.2.x/">doc</a>).</p>
            ...
            <h5>Note:</h5>
            <div>
              <p>Previously, I coded an angular (2+) wrapper to <a href="https://nathancahill.github.io/Split.js/">Split.js</a> library (<a href="https://github.com/aspojo/ng2-split/">ng2-split</a>) but I decided to rewrite it purely in Angular for following reasons:</p>
              <ul>
...
export class HomeComponent {
  code1: string = `npm install ngx-ui-split`

  code2: string = `import { AngularSplitModule } from 'ngx-ui-split';
...
export class AppModule {}`
  ...
  map: {
    'angular-split': 'node_modules/ngx-ui-split/bundles/angular-split.umd.js',
    ...
  },
  ...
});`
